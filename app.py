...
INSTITUTIONS = ['Harvard University', 'Stanford University', 'MIT', 'Oxford University', 'Cambridge University']
...
def upload_form():
    ...
    return render_template('upload_folder.html', user_uploads=user_uploads, institutions=INSTITUTIONS)
